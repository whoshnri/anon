...
export const initialMessages: Message[] = [
  { id: 1, content: "What's a thought you've had that you've never told anyone?", timestamp: "2h ago" },
  { id: 2, content: "If you could erase one memory, what would it be?", timestamp: "4h ago" },
  { id: 3, content: "What's something you pretend to understand but actually don't?", timestamp: "6h ago" },
  { id: 4, content: "What's the biggest lie you've ever told?", timestamp: "8h ago" },
  { id: 5, content: "If everyone could hear your thoughts for 1 minute, what moment would you be most afraid of?", timestamp: "10h ago" },
  { id: 6, content: "Have you ever caught feelings for someone you shouldn't have?", timestamp: "12h ago" },
  { id: 7, content: "What's your most embarrassing crush story?", timestamp: "1d ago" },
  { id: 8, content: "What's the most toxic thing you've ever done (be honest)?", timestamp: "1d ago" },
  { id: 9, content: "Have you ever flirted with someone while in a relationship?", timestamp: "2d ago" },
  { id: 10, content: "What's a secret you're taking to the grave?", timestamp: "2d ago" },
];
...
const UserPage = () => {
  ...
  useEffect(() =>{
    const anonymousQuestions = async({user:string}) => {
  ...
  useEffect(() =>{
    ...
    const slug = text
        ...
        .replace(/-+/g, '-')
        .replace(/^-+|-+$/g, '');
    const link = `http://localhost:3000/${user}/${slug}`
    setLink(link)
  }
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-3 h-2 animate-pulse bg-green-400 rounded-full" />
